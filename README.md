...
Подробнее как делать запрос описано в [файле](src/request_examples.txt).
...
Сервис доступен по http://127.0.0.1:8000/post/recommendations/, где задав параметры можно протестировать запрос на выдачу ленты. Примеры запросов есть [здесь](src/request_examples.txt).
